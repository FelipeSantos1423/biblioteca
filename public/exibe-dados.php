...
$livros = $livroRepo->listarPorUsuario($usuario->getId());
?>
<!DOCTYPE html>
<html>
<head>
...
<body>
    ...
    <h3>Sair da conta: <a href="logout.php">Logout</a></h3>
    <h3>Cadastrar Livro: <a href="cadastro-livro.php">Cadastrar</a></h3>
            ...
            <?php foreach ($livros as $livro): ?>
                <tr>
                    ...
                    <td>
                        ...
                        <a href="../processs/process_excluir_livro.php?id=<?= $livro->getId(); ?>" onclick="return confirm('Tem certeza que deseja excluir este livro?');">Excluir</a>
                    </td>
                </tr>
            <?php endforeach; ?>
        </table>
